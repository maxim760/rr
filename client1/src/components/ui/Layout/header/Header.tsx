...
export const Header: FC<IProps> = ({hideLinks}) => {
  ...
  const links =hideLinks ? [] : isAdmin ? AdminLinks : UserLinks
          ...
          <Toolbar variant="dense" disableGutters>
            ...
            >
              <LogoIcon
                fontSize="medium"
              />
              <Typography sx={{ml: 2, fontSize: "1.5rem", color: "white"}}>Miracle</Typography>
            </Link>

            <Box
              component="nav"
              sx={{
                display: { xs: 'none', sm: 'none', alignItems: "center" },
                ml: 'auto',
        ...
        >
          <Box onClick={handleDrawerToggle} sx={{ textAlign: 'center' }}>
            ...
            <List>
              ...
              {user && (<ListItem key="logout" disablePadding onClick={onClickLogout}>
                    <NavbarLink to={RouterPaths.Login}  classesInner>
                      <ListItemText primary="Выход" className="link" />
                    </NavbarLink>
                  </ListItem>
              )}
            </List>
